  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroPiano}
          alt="Natalia Uchitel performing at a grand piano"
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-6">
        <p className="animate-fade-in font-body text-sm tracking-[0.35em] uppercase text-primary">
          Pianist
        </p>
        ...
        <div className="animate-reveal-up delay-500 mt-10 flex gap-4">
          <a
            href="#biography"
            className="font-body rounded-none border border-primary/40 px-8 py-3 text-xs tracking-[0.2em] uppercase text-foreground transition-all duration-300 hover:border-primary hover:bg-primary/10 active:scale-[0.97]"
          >
            Biographie
          </a>
          <a
            href="#concerts"
            className="font-body rounded-none border border-primary bg-primary px-8 py-3 text-xs tracking-[0.2em] uppercase text-primary-foreground transition-all duration-300 hover:bg-primary/90 active:scale-[0.97]"
          >
            Konzerte
          </a>
        </div>
      ...
      <div className="absolute right-6 top-6 z-20 flex gap-4 animate-fade-in delay-700">
        <span className="font-body cursor-pointer text-xs tracking-[0.15em] uppercase text-foreground/60 transition-colors hover:text-primary">DE</span>
        <span className="font-body cursor-pointer text-xs tracking-[0.15em] uppercase text-foreground/40 transition-colors hover:text-primary">EN</span>
        <span className="font-body cursor-pointer text-xs tracking-[0.15em] uppercase text-foreground/40 transition-colors hover:text-primary">RU</span>
      </div>
      ...
      <div className="absolute bottom-8 left-1/2 z-20 -translate-x-1/2 animate-fade-in delay-800">
        <div className="flex flex-col items-center gap-2">
          <span className="font-body text-[10px] tracking-[0.3em] uppercase text-foreground/30">Scroll</span>
